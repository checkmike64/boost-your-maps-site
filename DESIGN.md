...
## 4. Components
- Primary button: deep red `#C5221F`, white text, radius 12, tinted red glow shadow, hover lifts 2px, active scale .98. This pair passes WCAG AA for normal text. Homepage CTA buttons lead to the Visibility Report section; the final CTA uses the approved plain-English wording.
